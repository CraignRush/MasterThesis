...
%	\includegraphics[width=\linewidth]{Ressources/Simulation/FlowShearFigure}
	\capption{Flow Field and Shear Stress Simulation of the utilized Microchannel}{(\textbf{a}, \textbf{c}) Whole Microchannel  (\textbf{b}, \textbf{d}) Particle on bottom, vges = \SI{12670.83}{\micro\meter\per\second}, vbottom \SI{2241.59}{\micro\meter\per\second} \SI{4.9293}{\dyne\per\centi\meter\squared} }
