...
\newacronym{alox}{Al$_\protect\text{2}$Ox$_\protect\text{3}$}{\iupac{aluminium oxide}}
...
\newacronym{el:vp}{V$_\protect\text{p}$}{peak voltage}

\newacronym{el:vpp}{V$_\protect\text{pp}$}{peak-to-peak voltage}
...
\newacronym{kd}{K$_\protect\text{d}$}{dissociation constant}


%%%%%%%%% MODELLING
\newacronym{t}{$\protect\mathbf{T}_\protect\text{crit}$}{critical tension}
...
\newacronym{vc}{$v_\protect\text{c}$}{bead velocity}

\newacronym{dgmr}{$d_\protect\text{GMR}$}{GMR bridge distance}

\newacronym{fs}{$f_\protect\text{s}$}{sampling frequency}

\newacronym{corrVel}{$C_\protect\text{velocity}$}{velocity correction factor}

\newacronym{corrConst}{$C_\protect\text{const}$}{linear fit correction factor}

\newacronym{corrRoll}{$C_\protect\text{rr}$}{rolling resistance factor}
...
\newacronym{u:s}{$\protect\mathbf{u}_\protect\text{s}$}{sedimentation velocity}

\newacronym{bodyforce}{$\sum_\protect\text{i}\protect\mathbf{F}_\protect\text{i}$}{body forces}

\newacronym{f:drag}{$\protect\mathbf{F}_\protect\text{drag}$}{Stoke's drag force}

\newacronym{f:grav}{$\protect\mathbf{F}_\protect\text{grav}$}{gravity}

\newacronym{f:buoyancy}{$\protect\mathbf{F}_\protect\text{buoyancy}$}{buoyancy}

\newacronym{f:el}{$\protect\mathbf{F}_\protect\text{el}$}{Coulomb's force}

\newacronym{f:mag}{$\protect\mathbf{F}_\protect\text{mag}$}{magnetic force}

\newacronym{f:magnus}{$\protect\mathbf{F}_\protect\text{magnus}$}{Magnus lift force}

\newacronym{f:shear}{$\protect\mathbf{F}_\protect\text{shear}$}{shear-induced lift force}

\newacronym{f:protein}{$\protect\mathbf{F}_\protect\text{protein}$}{protein-bond force}

\newacronym{f:saffman}{$\protect\mathbf{F}_\protect\text{saffman}$}{Saffman lift force}
...
\newacronym{re_p}{$\protect\mathit{Re}_\protect\text{particle}$}{particle Reynolds number}
