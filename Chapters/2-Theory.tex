...
\begin{figure}[!h]
	...
	\hfill	
	\subfloat{
		\subfigimg[height=150pt]{c}{./Ressources/Electronics/mrcyte}
	}
	\capption{MRCyte Overview}{Nice image of the MRCyte system with microscope.}
	\label{fig:MRCyte}
\end{figure}
