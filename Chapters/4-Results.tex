...
\begin{figure}[!htb]
	...
	\capption{Measured Bead Velocity}{ Not sure what to say about velocity itself. Maybe remove  p < 0.01}
	\label{fig:conc:vel}
\end{figure}
